...
#sh 905-install-personal-settings-bookmarks* - he has too many bookemarks on his folders its too cluttered for me
...
sh 923-fix-telegram*
#sh 930-autostart-applications* - change for your OWN desired autostart applications
...
#sh 960-ckb-next* - i dont have a corsair keyboard
#sh 970-alci*
sh 970-ariser*
#sh 970-arch*
#sh 970-carli*
